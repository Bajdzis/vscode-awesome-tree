...
export const Footer: React.FC<{}> = () => {
    return <footer className="footer">
        ...
        <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fmarketplace.visualstudio.com%2Fitems%3FitemName%3Dbajdzis.awesome-tree&t=Awesome%20extension!">share on facebook</a>
        {' or '}

...
import { onRegisterWorkspace, OnRegisterWorkspaceParam, registerTemplates, createNewTemplate, CreateNewTemplateParam, CreateNewTemplateResult } from '../../action/files/files';
import {  getTemplatesDatabaseAsync } from '../../../savedTemplates/getMatchingTemplate';
...
type InputAction = 
    Action<OnRegisterWorkspaceParam> | Action<CreateNewTemplateParam> | Action<{params: CreateNewTemplateParam, result: CreateNewTemplateResult}>;
